...
#    Then I verify that updating Team info successful with "<name>" "<manager>" "<teamofficer1>" "<teamfolder>" "<description>"
    Examples:
      | name      | manager          | teamofficer1 | teamofficer2 | logo                                   | teamfolder                                  | description       |
      | Android 2 | Thuy Nguyen T.H. | Tri Nguyen T | Huy Nguyen   | /Users/huethai/Pictures/teamavatar.jpg | http://portal-stg.asiantech.vn/organisation | There is My Team! |
