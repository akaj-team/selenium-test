 ...
 */
public class TimeSheetDefinitions extends BaseDefinitions implements En {
    ...
    public TimeSheetDefinitions() {
        ...
        Given("^My Timesheet page is displayed \"([^\"]*)\"$", this::redirectPageWhenClickChildItem);
        Then("^Display title timesheet content$", () -> Assert.assertTrue(myTimeSheet.isDisplayTitle()));
        ...
        And("^Click on columns timesheet$", myTimeSheet::clickColumnsTimeSheet);
