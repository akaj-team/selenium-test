...
public class LeaveBalanceDefinitions extends DriverBase implements En {
    ...
    public LeaveBalanceDefinitions() {
        ...
        And("^Display leave balance page$", () -> {
            ...
            Assert.assertEquals(driver.getCurrentUrl(), "http://portal-stg.asiantech.vn/leave/balance");
        });
        ...
        When("^I select item \"([^\"]*)\"$", (String arg0) -> leaveBalancePage.filterItemClick(2));
        ...
        When("^I click on page number (\\d+)$", (Integer arg0) -> leaveBalancePage.gotoPage(driver, arg0 - 1));
